...
public class SubtitleCollapsingToolbarLayout extends FrameLayout {
    ...
    public SubtitleCollapsingToolbarLayout(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        @SuppressLint("RestrictedApi") TypedArray a = ThemeEnforcement.obtainStyledAttributes(context, attrs, R.styleable.SubtitleCollapsingToolbarLayout, defStyleAttr, R.style.Widget_Design_SubtitleCollapsingToolbar);

        collapsingTextHelper.setExpandedTextGravity(a.getInt(R.styleable.SubtitleCollapsingToolbarLayout_expandedTitleGravity, GravityCompat.START | Gravity.BOTTOM));
        collapsingTextHelper.setCollapsedTextGravity(a.getInt(R.styleable.SubtitleCollapsingToolbarLayout_collapsedTitleGravity, GravityCompat.START | Gravity.CENTER_VERTICAL));

        if (a.hasValue(R.styleable.SubtitleCollapsingToolbarLayout_expandedTitleMarginStart)) {
            expandedMarginStart = a.getDimensionPixelSize(R.styleable.SubtitleCollapsingToolbarLayout_expandedTitleMarginStart, 0);
        }
        if (a.hasValue(R.styleable.SubtitleCollapsingToolbarLayout_expandedTitleMarginEnd)) {
            expandedMarginEnd = a.getDimensionPixelSize(R.styleable.SubtitleCollapsingToolbarLayout_expandedTitleMarginEnd, 0);
        }
        if (a.hasValue(R.styleable.SubtitleCollapsingToolbarLayout_expandedTitleMarginTop)) {
            expandedMarginTop = a.getDimensionPixelSize(R.styleable.SubtitleCollapsingToolbarLayout_expandedTitleMarginTop, 0);
        }
        if (a.hasValue(R.styleable.SubtitleCollapsingToolbarLayout_expandedTitleMarginBottom)) {
            expandedMarginBottom = a.getDimensionPixelSize(R.styleable.SubtitleCollapsingToolbarLayout_expandedTitleMarginBottom, 0);
        }
        
        expandedMarginStart = expandedMarginTop = expandedMarginEnd = expandedMarginBottom = a.getDimensionPixelSize(R.styleable.SubtitleCollapsingToolbarLayout_expandedTitleMargin, 0);
        ...
        // First load the default text Appearance
        collapsingTextHelper.setExpandedTitleTextAppearance(R.style.TextAppearance_Design_SubtitleCollapsingToolbar_ExpandedTitle);
        collapsingTextHelper.setCollapsedTitleTextAppearance(R.style.TextAppearance_Design_SubtitleCollapsingToolbar_CollapsedTitle);
        collapsingTextHelper.setExpandedSubtitleTextAppearance(R.style.TextAppearance_Design_SubtitleCollapsingToolbar_ExpandedSubtitle);
        collapsingTextHelper.setCollapsedSubtitleTextAppearance(R.style.TextAppearance_Design_SubtitleCollapsingToolbar_CollapsedSubtitle);

        // Now overlay any custom text appearances
        if (a.hasValue(R.styleable.SubtitleCollapsingToolbarLayout_expandedTitleTextAppearance)) {
            collapsingTextHelper.setExpandedTitleTextAppearance(a.getResourceId(R.styleable.SubtitleCollapsingToolbarLayout_expandedTitleTextAppearance, 0));
        }
        if (a.hasValue(R.styleable.SubtitleCollapsingToolbarLayout_collapsedTitleTextAppearance)) {
            collapsingTextHelper.setCollapsedTitleTextAppearance(a.getResourceId(R.styleable.SubtitleCollapsingToolbarLayout_collapsedTitleTextAppearance, 0));
        }
        if (a.hasValue(R.styleable.SubtitleCollapsingToolbarLayout_expandedSubtitleTextAppearance)) {
            collapsingTextHelper.setExpandedSubtitleTextAppearance(a.getResourceId(R.styleable.SubtitleCollapsingToolbarLayout_expandedSubtitleTextAppearance, 0));
        }
        if (a.hasValue(R.styleable.SubtitleCollapsingToolbarLayout_collapsedSubtitleTextAppearance)) {
            collapsingTextHelper.setCollapsedSubtitleTextAppearance(a.getResourceId(R.styleable.SubtitleCollapsingToolbarLayout_collapsedSubtitleTextAppearance, 0));
        }

        scrimVisibleHeightTrigger = a.getDimensionPixelSize(R.styleable.SubtitleCollapsingToolbarLayout_scrimVisibleHeightTrigger, -1);

        scrimAnimationDuration = a.getInt(R.styleable.SubtitleCollapsingToolbarLayout_scrimAnimationDuration, DEFAULT_SCRIM_ANIMATION_DURATION);
    ...
    protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
        ...
        if (collapsingTitleEnabled && dummyView != null) {
            ...
            if (drawCollapsingTitle) {
                ...
                collapsingTextHelper.setCollapsedBounds(tmpRect.left + (isRtl ? toolbar.getTitleMarginEnd() : toolbar.getTitleMarginStart()), tmpRect.top + maxOffset + toolbar.getTitleMarginTop(), tmpRect.right - (isRtl ? toolbar.getTitleMarginStart() : toolbar.getTitleMarginEnd()), tmpRect.bottom + maxOffset - toolbar.getTitleMarginBottom());
    ...
    public void setExpandedTitleTextSize(float textSize) {
        collapsingTextHelper.setExpandedTitleTextSize(textSize);
    }

    public void setCollapsedTitleTextSize(float textSize) {
        collapsingTextHelper.setCollapsedTitleTextSize(textSize);
    }

    public void setExpandedSubtitleTextSize(float textSize) {
        collapsingTextHelper.setExpandedSubtitleTextSize(textSize);
    }

    public void setCollapsedSubtitleTextSize(float textSize) {
        collapsingTextHelper.setCollapsedSubtitleTextSize(textSize);
    }
    
    
    //getTextSize
    public void getExpandedTitleTextSize() {
        collapsingTextHelper.getExpandedTitleTextSize();
    }

    public void getCollapsedTitleTextSize() {
        collapsingTextHelper.getCollapsedTitleTextSize();
    }

    public void getExpandedSubtitleTextSize() {
        collapsingTextHelper.getExpandedSubtitleTextSize();
    }

    public void getCollapsedSubtitleTextSize() {
        collapsingTextHelper.getCollapsedSubtitleTextSize();
    }
