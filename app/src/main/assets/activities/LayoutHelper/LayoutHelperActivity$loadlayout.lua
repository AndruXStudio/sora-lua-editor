...
loadlayout_error = false

local p={
  "com.load.LuaAppX.widget.*",
...
local ContextThemeWrapper, DisplayMetrics, Context, NineBitmapDrawable, File, ViewGroup, ArrayPageAdapter, AppBarLayoutLayoutParams, BasePagerAdapter, ArrayListAdapter, ArrayList, String, Typeface, Gravity, OnClickListener, OnLongClickListener, TypedValue, BitmapDrawable, LuaBitmapDrawable, LuaAdapter, AdapterView, ScaleType, TruncateAt, Glide =
bindClass "androidx.appcompat.view.ContextThemeWrapper", bindClass "android.util.DisplayMetrics", bindClass "android.content.Context", bindClass "com.androlua.NineBitmapDrawable", bindClass "java.io.File", bindClass "android.view.ViewGroup", bindClass "android.widget.ArrayPageAdapter", bindClass "com.google.android.material.appbar.AppBarLayout$LayoutParams", bindClass "github.daisukiKaffuChino.LuaPagerAdapter", bindClass "android.widget.ArrayListAdapter", bindClass "java.util.ArrayList", bindClass "java.lang.String", bindClass "android.graphics.Typeface", bindClass "android.view.Gravity", bindClass "android.view.View$OnClickListener", bindClass "android.view.View$OnLongClickListener", bindClass "android.util.TypedValue", bindClass "android.graphics.drawable.BitmapDrawable", bindClass "com.androlua.LuaBitmapDrawable", bindClass "com.androlua.LuaAdapter", bindClass "android.widget.AdapterView", bindClass "android.widget.ImageView$ScaleType", bindClass "android.text.TextUtils$TruncateAt", bindClass "com.bumptech.glide.Glide"
...
local function setattribute(root, view, params, k, v, ids)
 ...
 elseif k == "textStyle"
  if v == "bold"
   ...
   elseif v == "bold_italic"
    view.typeface = Typeface.defaultFromStyle(Typeface.BOLD_ITALIC)
   elseif v == "italic"
...
local function loadlayout(t, root, group, p)
  ...
  if p
    ...
    view.setTag(t)
    if group and group == AbsoluteLayout
      view.onTouch = mods.move
     else
      view.onTouch = mods.onTouch
    end
  end
  local vgw, vgh
  pcall(setMiniSize, view)

  if view.getBackground() == nil

    local gd = GradientDrawable()
    gd.setColor(0)
    gd.setStroke(2,Colors.colorOutline,5,5)
