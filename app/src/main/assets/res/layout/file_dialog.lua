    ...
    h="fill",
    {
      ...
      },
      {
        ...
        },
        {
          ...
          w="25%w",
          layout_weight=1,
          text=res.string.file .. "(" .. res.string.tong .. ")",
          backgroundDrawable=ColorUtil.getRipple(),
        ...
        },
        {
          ...
          Color=Colors.colorPrimary,
          layout_weight=1,
          text=res.string.folder .. "(" .. res.string.tong .. ")",
          backgroundDrawable=ColorUtil.getRipple(),
      ...
      },
      {
        ...
        Title="Type",
        id="prefType",
        Icon=res.drawable.ic_chart_bubble,
        IconColor=Colors.colorOutline,
      },
      {
        Preference,
      ...
      },
      {
        ...
        Title="File Path",
        id="perfPath",
        Icon=res.drawable.ic_insert_drive_file,
        IconColor=Colors.colorOutline,
      },
    }
  }
