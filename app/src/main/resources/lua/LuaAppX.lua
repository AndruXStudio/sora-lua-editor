...
function 标题栏背景(color)
  import "android.graphics.drawable.ColorDrawable"
  activity.getSupportActionBar().setBackgroundDrawable(ColorDrawable(color))
end
...
function 删除文件(file)
  return LuaUtil.rmDir(file)
end

function 解压文件(file,file1)
  return LuaUtil.unzip(file,file1)
end

function 压缩文件(file,file1)
  return LuaUtil.zip(file,file1)
end

function 复制文件(file,file1)
  return LuaUtil.copyDir(file,file1)
end

function 获取文件MD5(file)
  return LuaUtil.getFileMD5(file)
end

function 获取文件Sha1(file)
  return LuaUtil.getFileSha1(file)
end
